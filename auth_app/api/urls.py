...
from .views import RegistrationView, ActivateAccountView, LoginView, LogoutTokenDeleteView, CookieTokenRefreshView, PasswordResetView, PasswordResetConfirmView
