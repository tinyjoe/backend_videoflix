...
from .views import RegistrationView, ActivateAccountView, LoginView, LogoutTokenDeleteView, CookieTokenRefreshView, PasswordResetRequestView, PasswordResetConfirmView
